...
%set parameters for feature extractor
sigma = 0.77;
theta = 0.33;
...
plot(T1,seq1(2,:),'b');
hold on 
plot(T1,repmat(sigma,1,size(seq1(2,:),2)),'--r');
grid on 
...
plot(T2,seq2(2,:),'b');
hold on 
plot(T2,repmat(sigma,1,size(seq2(2,:),2)),'--r');
grid on 
...
plot(T3,seq3(2,:),'b');
hold on 
plot(T3,repmat(sigma,1,size(seq3(2,:),2)),'--r');
grid on 
...
plot(T1,newint1,'b');
hold on 
plot(T1,repmat(theta,1,size(seq1(2,:),2)),'--r');
grid on 
...
plot(T2,newint2,'b');
hold on 
plot(T2,repmat(theta,1,size(seq2(2,:),2)),'--r');
grid on 
...
plot(T3,newint3,'b');
hold on 
plot(T3,repmat(theta,1,size(seq3(2,:),2)),'--r');
grid on 
...
feature1 = FeatureExtract(seq1,sigma,theta);
feature2 = FeatureExtract(seq2,sigma,theta);
feature3 = FeatureExtract(seq3,sigma,theta);
...
trans_feature = FeatureExtract(transSeq,sigma,theta);
